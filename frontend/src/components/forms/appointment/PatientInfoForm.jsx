...
const PatientInfoForm = ({ formData, setFormData, priorities, error }) => {
  const handleSelectChange = async (value, fullname) => {
    setFormData((prev) => ({
      ...prev,
    ...
    const res = await api.get('/api/filter/visit-count', { params });
    ...
    <div className='max-w-xl mx-auto space-y-6'>
      <div>
        <SelectReact
          ...
          inputChange={(value, fullname) => handleSelectChange(value, fullname)}
          labelKey='fullname'
        />
