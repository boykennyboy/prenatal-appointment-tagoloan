...
const PrenatalVisitReports = () => {
  const downloadReport = async () => {
    try {
      ...
      const response = await api.get('/api/prenatal-visits', { params });
      const allData = response.data?.data || response.data || [];

      // Create workbook
      const workbook = new XLSX.Workbook();
      workbook.creator = 'Prenatal Visit System';
...
export default PrenatalVisitReports;
